...
<div class="row">
    <div class="col-12 p-3 w-100">
         ...
         <div class="d-flex justify-content-end py-4">
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalCadastrarProduto">
              Cadastrar Produto
            </button>
...
@endif
        ...
        @endif  
            ...
            <div class="modal fade" id="modalCadastrarProduto" tabindex="-1" aria-hidden="true">
                    ...
                    <div>
                      <form action="{{ route('produtos.store') }}" method="POST">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            <label for="variacoestype">Variações:</label>
                          ...
                          <div class="col-12 my-3 registarper">
                            <div class="w-100 align-items-center">
                              <a href="#" id="Adicionar_campo" class="ml-2">Adicionar variações</a>
                            </div>
...
<!-- Modal (pode esconder por padrão e mostrar via JS) -->
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="carrinhoOffcanvas">
        ...
        <div class="offcanvas-body">
          ...
          <button class="btn btn-secondary w-100 mb-3" onclick="calcularFrete()">Calcular Frete</button>
          ...
          <button class="btn btn-primary w-100 mb-3" onclick="aplicarCupom()">Aplicar Cupom</button>
